    ...
    <div id="wu-toolbar">
        ...
        <div class="wu-toolbar-search">
	           ...
	           <input id="search-companyName"  class="easyui-combobox"  data-options="editable: false,valueField:'companyId',textField:'companyName',url:'${pageContext.request.contextPath}/admin/company/getCompanyNameList'" style="width: 150px;">
	            ...
	            <a href="#" id="Detail-btn" class="easyui-linkbutton" iconCls="icon-search" onclick="openDetail()">显示详情???</a>
		</div>
...
<!--显示详情页页面start-->
<div id="showDetail-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:800px; padding:10px;height:600px">
	<form id="showDetail-form" method="post">
        <input type="hidden" name="stuId" id="detail-Id">
       <table cellpadding="8" border=" 1px solid" align="center">
