	...
	<form id="add-form" method="post">
        <table>
            ...
            <tr>
                ...
                <td><input type="text" name="birthday" class="wu-text easyui-numberbox easyui-validatebox"/></td>
            </tr>
            <tr>
	...
	<form id="edit-form" method="post">
        ...
        <table>
            <tr>
                <td width="60" align="right">头像预览:</td>
                <td valign="middle">
                	<img id="edit-preview-photo" style="float:left;" src="${pbirthdayContext.request.contextPath}/resources/admin/easyui/images/user_photo.jpg" width="100px">
                	<a style="float:left;margin-top:40px;" href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-upload" onclick="uploadPhoto()" plain="true">上传图片</a>
                </td>
            </tr>
            <tr>
                <td width="60" align="right">头像:${pageContext.request.contextPath}</td>
            ...
            <tr>
                <td width="60" align="right">出生日期:</td>
                <td><input type="text" id="edit-age" name="birthday" class="wu-text easyui-numberbox easyui-validatebox" data-options="required:true,min:1,precision:0, missingMessage:'请填写出生日期'" /></td>
            </tr>
            <tr>
                <td width="60" align="right">地址:</td>
